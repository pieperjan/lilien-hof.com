...
function prefix_footer_code() {
    ...
    wp_enqueue_script( 'ausstattung-js', get_stylesheet_directory_uri() . '/Assets/js/ausstattung.js', '', '', true );
    wp_enqueue_script( 'hoveranimation-js', get_stylesheet_directory_uri() . '/Assets/js/hoveranimation.js', '', '', true );
}
